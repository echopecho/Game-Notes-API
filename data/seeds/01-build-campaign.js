      ...
      await knex("notes").insert([
        {
          ...
          campaign_id: campaigns[0].id,
          author_id: user.id,
          created_at: new Date(Date.UTC(2020, 1, 1, 1, 0)),
        },
        {
          text: "We met a guy",
          location_id: locations[0].id,
          campaign_id: campaigns[0].id,
          author_id: user.id,
          created_at: new Date(Date.UTC(2020, 1, 1, 1, 10)),
        },
        {
          ...
          campaign_id: campaigns[0].id,
          author_id: user.id,
          created_at: new Date(Date.UTC(2020, 1, 1, 1, 20)),
        },
        {
          ...
          campaign_id: campaigns[0].id,
          author_id: user.id,
          created_at: new Date(Date.UTC(2020, 1, 2, 1, 0)),
        },
        {
          ...
          campaign_id: campaigns[0].id,
          author_id: user.id,
          created_at: new Date(Date.UTC(2020, 1, 2, 1, 10)),
        },
        {
          text: "Session three",
          location_id: locations[3].id,
          campaign_id: campaigns[0].id,
          author_id: user.id,
          created_at: new Date(Date.UTC(2020, 1, 3, 1, 0)),
        },
        {
          ...
          campaign_id: campaigns[0].id,
          author_id: user.id,
          created_at: new Date(Date.UTC(2020, 1, 4, 1, 0)),
        },
        {
          ...
          campaign_id: campaigns[0].id,
          author_id: user.id,
          created_at: new Date(Date.UTC(2020, 1, 4, 1, 10)),
        },
      ]);
    });
};
